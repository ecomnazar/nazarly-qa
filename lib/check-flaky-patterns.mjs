...
const PATTERNS = [
  ...
  ['networkidle', /['"`]networkidle['"`]/, "'networkidle' wait — Playwright discourages it for tests: one poll/analytics/websocket keeps the network busy and the wait flakes; wait for a web-first assertion instead. Legit only to assert no background traffic → allowlist it"],
